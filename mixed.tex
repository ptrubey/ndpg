...
Let $z_{i\ell} = \frac{1}{1 - \hat{F}(x_{i\ell})}$ be the 
    ...
    \makenote{In retrospect, I'm actually not convinced about this.  Rather,
        we may end up with the moment constraint on the angular distribution.
        It might make sense to explicitly say we're ignoring said constraint.}
