...
\begin{equation*}
  S_i^{\text{lekde}} = 
  \text{E}\left[\exp\left\lbrace-\frac{1}{2}\left(\frac{\lVertR_i\bm{v}_i - R\bm{V}\rVert}{h}\right)^2\right]
\end{equation*}

\begin{equation*}
  S_i^{\text{lhkde}} = 
  \text{E}\left[\exp\left\lbrace-\frac{1}{2}\left(\frac{d(bm{v}_i,\bm{V})}{h}\right)^2\right]
\end{equation*}
