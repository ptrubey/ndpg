...
We subjected six datasets to multivariate thresholding on their numerical 
    variables, only keeping 
    ...
    more manageably sized dataset.  For variables that did not exhibit 
